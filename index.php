...
<body class="container">
    ...
    <h1 class="mb-4">Gestió del catàleg i eXistDB</h1>

    <!-- Botó per crear cataleg.xml -->
    <form method="post" class="mb-4">
        <button type="submit" name="crearXML" class="btn btn-primary">Crear cataleg.xml</button>
    </form>

    <!-- Crear col·lecció -->
    <h2>Crear nova col·lecció a eXistDB</h2>
    <form method="post" class="mb-4">
        <input type="text" name="nom_colleccio" class="form-control mb-2" placeholder="Nom de la col·lecció" required>
        <button type="submit" name="crearColleccio" class="btn btn-warning">Crear col·lecció</button>
    </form>
    ...
    <form method="post" class="mb-4">
        ...
        <input type="text" name="destinacio" class="form-control mb-2" placeholder="Nom de la col·lecció (ex: Projecte)"
            required>
        <button type="submit" name="pujarDocument" class="btn btn-success">Pujar document</button>
    </form>
